...
public class Shell extends Algorithms implements Sort {
    ...
    public Result ordenarMelhorCaso (int tamanhoVetor) {
        ...
        return new Result(2, 16, resultado.getMedia(), resultado.getDesvioPadrao(), comparacoes,"Ordenacao Melhor Caso", tamanhoVetor);
    }
    ...
    public Result ordenarCasoMedio(int tamanhoVetor) {
        ...
        return new Result(2, 17, resultado.getMedia(), resultado.getDesvioPadrao(), comparacoes,"Ordenacao Caso Medio", tamanhoVetor);
    }
    ...
    public Result ordenarPiorCaso(int tamanhoVetor) {
        ...
        return new Result(2, 18, resultado.getMedia(), resultado.getDesvioPadrao(), comparacoes,"Ordenacao Pior Caso", tamanhoVetor);
    }
